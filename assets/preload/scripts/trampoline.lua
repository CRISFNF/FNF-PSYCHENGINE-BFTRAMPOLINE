...
---@version 1.0.0 -- dunno what this is but its cool
...
local popupNum = 1 -- numerical identitifer for the popups for deletion
        ...
        if keyJustPressed("space") then
            if not pressedSpaceOnBounce then
                if points.peak[1] then
                    if getProperty('boyfriend.velocity.y') > -100 and getProperty('boyfriend.velocity.y') < 100 then
                        triggerEvent("Hey!", "", "")
